...
const PHOTOS: { id: number; src: string; alt: string; span: string }[] = [];

const SMALL_PHOTOS: string[] = [];
      ...
      `}</style>
            ...
            >
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto bg-[#1c1c1e] p-3 flex flex-col items-center justify-center text-center" style={{ scrollbarWidth: "thin", scrollbarColor: "rgba(255,255,255,0.12) transparent" }}>
                        {PHOTOS.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-12">
                                ...
                                <h3 className="text-white/80 text-[14px] font-semibold mb-1">No Photos</h3>
                                <p className="text-white/35 text-[12px] max-w-[240px] leading-relaxed">
                                    Photos and memories will appear here once added.
                                </p>
                            </div>
                        ) : (
                            <>
                                <p className={`text-[13px] font-semibold text-white/40 px-1 mb-2 transition-all duration-500 ${loaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"}`}>
                                    June 2026
                                </p>

                                <div className="grid gap-1.5 mb-4" style={{ gridTemplateColumns: "repeat(3, 1fr)", gridTemplateRows: "140px 120px" }}>
                                    {PHOTOS.map((photo, i) => (
                                        <div
                                            key={photo.id}
